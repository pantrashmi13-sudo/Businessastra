...
BEGIN
  ...
  VALUES
    ...
    (comp_id, '4000', 'PL', 'Revenue from Operations', 'Revenue from Operations', 'Trading Sales', 'Credit'),
    (comp_id, '4010', 'PL', 'Other Income', 'Other Income', 'Other Income', 'Credit'),
    (comp_id, '4020', 'PL', 'Other Income', 'Other Income', 'Rent Income', 'Credit'),
    (comp_id, '4030', 'PL', 'Other Income', 'Other Income', 'Service Income', 'Credit'),
